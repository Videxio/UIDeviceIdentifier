...
+ (NSString *) platformString
{
    ...
    NSDictionary *platformStrings = @{
            ...
            @"iPad8,2" : @"iPad Pro 3rd-gen 11-inch (WiFi)",
            @"iPad8,3" : @"iPad Pro 3rd-gen 11-inch (WiFi+Cellular)",
            @"iPad8,4" : @"iPad Pro 3rd-gen 11-inch (WiFi+Cellular)",
            @"iPad8,5" : @"iPad Pro 3rd-gen 12.9-inch (WiFi)",
            @"iPad8,6" : @"iPad Pro 3rd-gen 12.9-inch (WiFi)",
            @"iPad8,7" : @"iPad Pro 3rd-gen 12.9-inch (WiFi+Cellular)",
            @"iPad8,8" : @"iPad Pro 3rd-gen 12.9-inch (WiFi+Cellular)",
